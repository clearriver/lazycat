...
import com.stooges.platform.workflow.dao.HandupRecordDao;
...
public class HandupRecordServiceImpl extends BaseServiceImpl implements HandupRecordService {
    ...
    public void saveHandUpRecord(JbpmFlowInfo jbpmFlowInfo){
        ...
        dao.saveOrUpdate("JBPM6_HANDUPRECORD",handUpRecord,AllConstants.IDGENERATOR_UUID,null);
    }
    ...
    public Map<String,Object> restartJbpmTask(String recordId){
        ...
        dao.saveOrUpdate("JBPM6_HANDUPRECORD", handleRecord,AllConstants.IDGENERATOR_UUID,null);
        return result;
    }
    ...
    public void updateDays(){
        ...
        for(Map<String,Object> handle:list){
            ...
            dao.saveOrUpdate("JBPM6_HANDUPRECORD", handle,AllConstants.IDGENERATOR_UUID,null);
        }
    }
