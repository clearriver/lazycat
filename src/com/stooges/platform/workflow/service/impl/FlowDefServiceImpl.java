...
import com.stooges.platform.workflow.dao.FlowDefDao;
...
import com.stooges.platform.workflow.service.WordBindService;
...
public class FlowDefServiceImpl extends BaseServiceImpl implements FlowDefService {
    ...
    public Map<String,Object> saveOrUpdateCascade(Map<String,Object> flowDef){
        ...
        return dao.saveOrUpdate("JBPM6_FLOWDEF",flowDef, AllConstants.IDGENERATOR_UUID,null);
    }
    ...
    public void cloneFlowDef(String targetDefId,String newDefCode,String newDefName){
        ...
        newFlowDef = dao.saveOrUpdate("JBPM6_FLOWDEF",newFlowDef, AllConstants.IDGENERATOR_UUID,null);
    ...
    public void importDefConfig(String defConfJson){
        ...
        while (it.hasNext()) {
            ...
            for(Map<String,Object> map:list){
                dao.saveOrUpdate(tableName, map, AllConstants.IDGENERATOR_ASSIGNED, null);
            }
        }
    }
