...
import com.stooges.platform.workflow.dao.ExecutionDao;
...
public class ExecutionServiceImpl extends BaseServiceImpl implements ExecutionService {
    ...
    public void saveFlowExe(Map<String,Object> postParams,JbpmFlowInfo jbpmFlowInfo){
        ...
        if(StringUtils.isNotEmpty(jbpmExeId)&&!jbpmExeId.equals("-1")){
        ...
        dao.saveOrUpdate("JBPM6_EXECUTION",execution,AllConstants.IDGENERATOR_ASSIGNED,null);
        if(jbpmFlowInfo.getJbpmIsTempSave().equals("true")){
            jbpmFlowInfo.setJbpmStopExe("true");
        }
    ...
    public void endExecution(String[] exeIds){
        ...
        for(String exeId:exeIds){
            ...
            if(STATUS.equals(ExecutionService.STATUS_RUNNING)){
                ...
                dao.saveOrUpdate("JBPM6_EXECUTION", execution,AllConstants.IDGENERATOR_UUID,null);
            }
        }
    }
    ...
    public void updateLeftDays(){
        ...
        for(Map<String,Object> exe:exeList){
          ...
          //获取开始日期
            ...
            dao.saveOrUpdate("JBPM6_EXECUTION", exe,AllConstants.IDGENERATOR_UUID, null);
        }
    }
    ...
    public void updateExeVersionToNewest(String[] exeIds){
        for(String exeId:exeIds){ 
            ...
            dao.saveOrUpdate("JBPM6_EXECUTION",jbpmExe,AllConstants.IDGENERATOR_UUID,null);
        }
    }
