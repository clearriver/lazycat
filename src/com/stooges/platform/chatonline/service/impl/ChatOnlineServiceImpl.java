...
import com.stooges.platform.chatonline.dao.ChatOnlineDao;
...
public class ChatOnlineServiceImpl extends BaseServiceImpl implements ChatOnlineService {
    ...
    public void sendMessageFromUserToUser(Map<String, Object> mine,
        ...
        if(type.equals("friend")){
            ...
            if(PlatWebSocket.webSocketMap.get(NEWS_TO_USERID)!=null){
                ...
                newMessage.put("timestamp", new Date().getTime());
            ...
            news.put("NEWS_CREATETIME", PlatDateTimeUtil.formatDate(new Date(),
                    "yyyy-MM-dd HH:mm:ss"));
            dao.saveOrUpdate("PLAT_CHATONLINE_NEWS", news, AllConstants.IDGENERATOR_UUID, null);
        }else{
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if(null!=PlatWebSocket.webSocketMap.get(SYSUSER_ID)){
                        ...
                        dao.saveOrUpdate("PLAT_CHATONLINE_OFFLINENEWS", 
                                offlineMap, AllConstants.IDGENERATOR_UUID, null);
                    }
                }
            }
            Map<String,Object> news = new HashMap<String,Object>();
            ...
            news.put("GROUPNEWS_CREATETIME", PlatDateTimeUtil.formatDate(new Date(),
                    "yyyy-MM-dd HH:mm:ss"));
            dao.saveOrUpdate("PLAT_CHATONLINE_GROUPNEWS", news, AllConstants.IDGENERATOR_UUID, null);
        }
     ...
     * @param sysUser
     * @return
     * @see com.STOOGES.platform.chatonline.service.ChatOnlineService#findNoReadMsgUser(java.util.Map)
     */
    @Override
     ...
     * @return
     * @see com.STOOGES.platform.chatonline.service.ChatOnlineService#findMyGroupResult()
     */
    @Override
    ...
    public boolean isCanAddGroup(String id) {
        ...
        if(list!=null&&list.size()>0){
            ...
            dao.saveOrUpdate("PLAT_CHATONLINE_GROUPMEMBER", memberMap, AllConstants.IDGENERATOR_UUID, null);
