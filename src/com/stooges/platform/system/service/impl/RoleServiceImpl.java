...
import com.stooges.platform.system.dao.RoleDao;
...
public class RoleServiceImpl extends BaseServiceImpl implements RoleService {
    ...
    public List<Map<String,Object>> findByGroupId(String groupId){
        ...
        if(!isAdmin){
            ...
            sql.append(" WHERE T.ROLE_GROUPID IN ").append(PlatStringUtil.getSqlInCodition(grantGroupIds));
        }
    ...
    public Map<String,Object> saveOrUpdateRole(HttpServletRequest request,
        ...
        dao.saveOrUpdate("PLAT_SYSTEM_ROLE",
                postParams,AllConstants.IDGENERATOR_ASSIGNED,null);
