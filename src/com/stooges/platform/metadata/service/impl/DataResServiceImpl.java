...
import com.stooges.platform.common.dynadatasource.DynamicDataSourceHolder;
import com.stooges.platform.common.dynadatasource.DynamicDataSourceInterceptor;
...
public class DataResServiceImpl extends BaseServiceImpl implements DataResService {
    ...
    private Map<String,Object> getParamValidResult(List<Map<String,Object>> queryList,
        ...
        for(Map<String,Object> query:queryList){
            ...
            if(QUERY_NULLABLE.equals("-1")&&!StringUtils.isNotEmpty(postParamValue)){
    ...
    private Map<String, Object> exeInvoke(HttpServletRequest request,
        ...
        }else if(DATARES_RUTYPE.equals("2")){
            //获取接口
    ...
    public List<Map<String,Object>> findSqlDatas(String dbId,String sqlContent
        ...
        if(dbId.equals("-1")){
            ...
            String dbType = null;
            if(DBCONN_CLASS.equals("com.mysql.jdbc.Driver")){
                dbType = "MYSQL";
            }else if(DBCONN_CLASS.equals("com.microsoft.sqlserver.jdbc.SQLServerDriver")){
                dbType = "SQLSERVER";
            }else if(DBCONN_CLASS.equals("oracle.jdbc.driver.OracleDriver")){
                dbType = "ORACLE";
            }
            try {
