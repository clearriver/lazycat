...
import com.stooges.platform.appmodel.dao.DesignDao;
...
public class DesignServiceImpl extends BaseServiceImpl implements DesignService {
    ...
    public void genJavaCode(Map assoical,String codeType){
        String codeTplPath = PlatAppUtil.getCodeProjectPath()+"WebRoot/webpages/"
        ...
        String basePackage = "com/stooges/";
    ...
    public Map<String,Object> saveAndGenJavaCode(Map<String,Object> design){
        ...
        if(StringUtils.isNotEmpty(ASSOICAL_JSON)){
            ...
            for(Map assoical:assoicalList){
                String AUTHOR = PlatPropUtil.getPropertyValue("conf/config.properties","genCodeAuthor");
    ...
    public void copyDesignInfo(String sourceDesignId,
        ...
        newDesignInfo = this.saveOrUpdate("PLAT_APPMODEL_DESIGN",newDesignInfo,AllConstants.IDGENERATOR_UUID,null);
    ...
    private void deleteByDesignConfJson(String confJson){
        ...
        while (it.hasNext()) {
            ...
            for(Map<String,Object> map:list){
                if(tableName.equals("PLAT_APPMODEL_DESIGN")){
