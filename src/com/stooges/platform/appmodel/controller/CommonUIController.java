...
import com.stooges.core.util.CommonExcelView;
...
public class CommonUIController extends BaseController {
    ...
    public Map<String,String> getImageFile(String imgUrl){
        //获取附件的根路径
        String realPath = PlatPropUtil.getPropertyValue("conf/config.properties", "attachFilePath");
        //获取请求路径
