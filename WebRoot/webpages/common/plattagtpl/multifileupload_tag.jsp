...
<%@ page language="java" import="com.stooges.core.util.AllConstants"%>
<%@ page language="java" import="com.stooges.core.util.PlatBeanUtil"%>
<%@ page language="java" import="com.stooges.core.util.PlatAppUtil"%>
<%@ page language="java" import="com.stooges.core.util.PlatPropUtil"%>
<%@ page language="java" import="com.stooges.platform.appmodel.service.FileAttachService"%>
...
<%
    ...
    if (StringUtils.isNotEmpty(FILE_UPSERVER)&&"2".equals(FILE_UPSERVER)) {
        String fileServerUrl = PlatPropUtil.getPropertyValue("conf/config.properties","fileServerUrl");
    ...
    if (StringUtils.isEmpty(RIGHTS)) {
        Map<String, String> changeDefCtrlMap = (Map<String, String>) request
                .getAttribute(AllConstants.CHANGEDEFCTRLAUTHMAP_KEY);
