...
<html>
  <head>
	...
	<plattag:resources restype="css" loadres="bootstrap-checkbox,jquery-ui,jqgrid,jedate,select2,bootswitch,plat-ui,tipsy,layer,fancybox">
	</plattag:resources>
	<link rel="stylesheet" type="text/css" href="webpages/background/framework/css/portal.css">
	<plattag:resources restype="js" loadres="jquery-ui,jqgrid,jedate,select2,jquery-layout,bootswitch,plat-util,tipsy,layer,slimscroll,fancybox,echart,superslide">
	</plattag:resources>
        ...
        <div class="row" rowid="${row.ROW_ID}" id="${row.ROW_ID}">
        	...
        	<div class="col-sm-${conf.CONF_COLNUM}" >
            	<div id="${conf.CONF_ID}_COMP" class="eui-ibox ${conf.CONF_BORDERCOLOR}" DR_drag="1" DR_replace="1">
                	<div class="eui-itt" >
	                	<span>
	                	  <a href="javascript:void(0)" onclick="refreshComp('${conf.CONF_ID}','${conf.CONF_COMPURL}');" title="重新刷新"><img src="webpages/background/framework/images/icon.png"></a>
	                	  ...
	                	  <a href="javascript:void(0)" onclick="queryMore('${conf.RES_NAME}','${conf.RES_MENUICON}','${conf.RES_CODE}','${conf.RES_MENUURL}');" title="查看更多">
	                	  <img src="webpages/background/framework/images/more.png">
	                	  </a>
	                	  </c:if>
	                	</span><div id="${conf.CONF_ID}_TITLE" style="font-size: 18px;">${conf.CONF_TITLE}</div>
                	</div>
                    <div class="eui-icon">
                    	<div style="height: ${row.ROW_HEIGHT}px;" confurl="${conf.CONF_COMPURL}"  confid="${conf.CONF_ID}" id="${conf.CONF_ID}">
