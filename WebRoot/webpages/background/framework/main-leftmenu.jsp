	...
	<div id="jquery-accordion-menu" class="jquery-accordion-menu">
		<ul>
		    <c:forEach items="${resList}" var="top" varStatus="topStatus">
			    ...
			    <li resid="${res.RES_ID}" resname="${res.RES_NAME}" resicon="${res.RES_MENUICON}" resurl="${res.RES_MENUURL}" topmenuid="${top.RES_ID}" <c:if test="${topStatus.index>0}">style="display: none;"</c:if> >
			    ...
			    <c:if test="${(res.childres)!= null && fn:length(res.childres) > 0}">
			       <ul class="submenu">
						...
						<li resid="${res1.RES_ID}" resname="${res1.RES_NAME}" resicon="${res1.RES_MENUICON}" resurl="${res1.RES_MENUURL}" topmenuid="${top.RES_ID}"  >
			             ...
			             <c:if test="${(res1.childres)!= null && fn:length(res1.childres) > 0}">
					         <ul class="submenu">
								...
								<li resid="${res2.RES_ID}" resname="${res2.RES_NAME}" resicon="${res2.RES_MENUICON}" resurl="${res2.RES_MENUURL}"  topmenuid="${top.RES_ID}" >
