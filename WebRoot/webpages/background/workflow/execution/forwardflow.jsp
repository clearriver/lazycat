		...
		<div class="ui-layout-center" platundragable="true"
			...
			<form method="post" class="form-horizontal" compcode="formcontainer"
				...
				<div class="form-group plat-form-title" compcode="formtitle" id="">
					<span class="plat-current">转办环节信息</span>
				</div>
				...
				<div class="form-group" compcode="formgroup">
					...
					<plattag:winselector placeholder="请选择接收人" minselect="1" maxselect="1"
					   allowblank="false" height="90%" 
					   comp_col_num="4" auth_type="write" selectedlabels=""
					   selectorurl="system/RoleController.do?goUserGrant" 
					   label_col_num="2" label_value="接收人" value=""
					    width="90%" title="选择接收人" name="nextNodeAssignerIds_${varStatus.index}">
					</plattag:winselector>
				</div>
				<div class="hr-line-dashed"></div>
				</c:forEach>
				<div class="form-group plat-form-title" compcode="formtitle" id="">
					<span class="plat-current">转办理由</span>
				</div>
				<div class="form-group" compcode="formgroup">
				    <plattag:textarea name="HANDLE_OPINION" auth_type="write" allowblank="false"
				     comp_col_num="10" label_col_num="2" label_value="转办理由"  maxlength="1000"></plattag:textarea>
				</div>
				<div class="hr-line-dashed"></div>
			</form>
		</div>
