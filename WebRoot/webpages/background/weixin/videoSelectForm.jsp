   		...
   		<div class="img_pick">
	   		<ul class="group js_list img_list">
	   			...
	   			<li class="img_item js_imageitem" onclick="selectItem(this);">
	   				<label class="frm_checkbox_label img_item_bd" data-name="${imgItem.MEDIAMATTER_NAME}"  data-wxsrc="${imgItem.MEDIAMATTER_MEDIAURL}" data-videosrc="webpages/background/weixin/images/video.png">
	   					<div class="pic_box">
	   						<img class="pic js_pic" src="webpages/background/weixin/images/img-icon.png" style="height: 117px;">
	   					</div>
	...
	if(len==0){
		parent.layer.alert("请至少选择一项！",{icon: 2,resize:false});
			...
			$(" .frm_checkbox_label.selected").each(function(){
				...
				srcItem.wxsrc = wxsrc;
				srcItem.videosrc = videosrc;
				srcItem.mediaid = mediaid;
				srcItem.vname = vname;
				srcArr.push(srcItem);
			});
